...
My research focuses on **equilibrium learning**, aiming to develop model-based, offline, or online Multi-Agent Reinforcement Learning (MARL) algorithms with **last-iterate convergence guarantees** in dynamic games or multi-agent systems. I also proposed the **Equilibrium Policy Generalization** paradigm for real-time robust strategies under time-varying game dynamics.
